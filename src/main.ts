...
async function bootstrap() {
  ...
  const clientRepository = new ClientRepository(connection.getRepository(Client));
  const challengeRepository = new ChallengeRepository(connection.getRepository(Challenge));
