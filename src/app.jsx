...
const getAccounts = (container, clientName) => new Promise(async (resolve) => {
...
const askUserToSelectAnAccount = (container, accounts) => new Promise(resolve => {
