  ...
  })()(
    {
      1: [
        function (require, module, exports) {
          ...
          var ErrorInvalidReturnedStateParam = /** @class */ (function (
            _super
          ) {
          ...
          exports.ErrorInvalidReturnedStateParam =
          ...
          function toErrorClass(rawError) {
            return new (exports.RawErrorToErrorClassMap[rawError] ||
              ErrorUnknown)();
          }
          ...
          function fromWWWAuthenticateHeaderStringToObject(a) {
            var obj = a
              ...
              .reduce(function (a, c) {
                return __assign(__assign({}, a), c);
              }, {});
            return { realm: obj.realm, error: obj.error };
          }
          exports.fromWWWAuthenticateHeaderStringToObject =
          ...
          var OAuth2AuthCodePKCE = /** @class */ (function () {
             ...
             * classes.
             */
            OAuth2AuthCodePKCE.prototype.decorateFetchHTTPClient = function (
              fetch
            ) {
              var _this = this;
              return function (url, config) {
                ...
                if (!_this.state.isHTTPDecoratorActive) {
                  return fetch.apply(
                    void 0,
                    __spreadArrays([url, config], rest)
                  );
                }
                return _this
                  .getAccessToken()
                  .then(function (_a) {
                    ...
                    configNew.headers[HEADER_AUTHORIZATION] =
                      "Bearer " + token.value;
                    return fetch.apply(
                      void 0,
                      __spreadArrays([url, configNew], rest)
                    );
                  })
                  .then(function (res) {
                    if (res.ok) {
                    ...
                    if (
                      !res.headers.has(HEADER_WWW_AUTHENTICATE.toLowerCase())
                    ) {
                      return res;
                    }
                    var error = toErrorClass(
                      fromWWWAuthenticateHeaderStringToObject(
            ...
            OAuth2AuthCodePKCE.prototype.isReturningFromAuthServer =
              function () {
                var error = OAuth2AuthCodePKCE.extractParamFromUrl(
                  location.href,
                  "error"
                );
                if (error) {
                ...
                var code = OAuth2AuthCodePKCE.extractParamFromUrl(
                  location.href,
                  "code"
                );
                if (!code) {
                ...
                var state = JSON.parse(
                  localStorage.getItem(exports.LOCALSTORAGE_STATE) || "{}"
                );
                var stateQueryParam = OAuth2AuthCodePKCE.extractParamFromUrl(
                  location.href,
                  "state"
                );
              ...
              return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                  switch (_c.label) {
                    ...
                    case 1:
                      (_b = _c.sent()),
                        (codeChallenge = _b.codeChallenge),
                        (codeVerifier = _b.codeVerifier);
                      stateQueryParam = OAuth2AuthCodePKCE.generateRandomState(
                        exports.RECOMMENDED_STATE_LENGTH
                      );
                      ...
                      if (extraAuthorizationParams || oneTimeParams) {
                        extraParameters = __assign(
                          __assign({}, extraAuthorizationParams),
                          oneTimeParams
                        );
                        url =
                          url +
                          "&" +
                          OAuth2AuthCodePKCE.objectToQueryString(
                            extraParameters
                          );
                      }
            ...
            OAuth2AuthCodePKCE.prototype.getAccessToken = function () {
              ...
              var _a = this.state,
                ...
                authorizationCode = _a.authorizationCode,
                explicitlyExposedTokens = _a.explicitlyExposedTokens,
                hasAuthCodeBeenExchangedForAccessToken =
                  _a.hasAuthCodeBeenExchangedForAccessToken,
              ...
              if (
                ...
                this.authCodeForAccessTokenRequest =
             ...
             */
            OAuth2AuthCodePKCE.prototype.exchangeRefreshTokenForAccessToken =
              function () {
                var _this = this;
                var _a;
                this.assertStateAndConfigArePresent();
                var _b = this.config,
                  extraRefreshParams = _b.extraRefreshParams,
                  clientId = _b.clientId,
                  tokenUrl = _b.tokenUrl;
                ...
                var body =
                  ...
                  ("refresh_token=" +
                    ((_a = refreshToken) === null || _a === void 0
                      ? void 0
                      : _a.value) +
                    "&") +
                  ("client_id=" + clientId);
                if (extraRefreshParams) {
                  body =
                    url +
                    "&" +
                    OAuth2AuthCodePKCE.objectToQueryString(extraRefreshParams);
                }
                return fetch(url, {
                  method: "POST",
                  body: body,
                  ...
                  .then(function (json) {
                    var access_token = json.access_token,
                      ...
                      scope = json.scope;
                    var explicitlyExposedTokens =
                      _this.config.explicitlyExposedTokens;
                    var scopes = [];
                    var tokensToExpose = {};
                    var accessToken = {
                      value: access_token,
             ...
             */
            OAuth2AuthCodePKCE.prototype.isHTTPDecoratorActive = function (
              isActive
            ) {
            ...
            OAuth2AuthCodePKCE.prototype.isAccessTokenExpired = function () {
              ...
              return Boolean(
                accessToken && new Date() >= new Date(accessToken.expiry)
              );
            };
            /**
             ...
             */
            OAuth2AuthCodePKCE.prototype.assertStateAndConfigArePresent =
              function () {
             ...
             */
            OAuth2AuthCodePKCE.prototype.exchangeAuthCodeForAccessToken =
              function (codeOverride) {
                var _this = this;
                this.assertStateAndConfigArePresent();
                var _a = this.state,
                  _b = _a.authorizationCode,
                  authorizationCode = _b === void 0 ? codeOverride : _b,
                  _c = _a.codeVerifier,
                  codeVerifier = _c === void 0 ? "" : _c;
                var _d = this.config,
                  clientId = _d.clientId,
                  onInvalidGrant = _d.onInvalidGrant,
                  redirectUrl = _d.redirectUrl;
                if (!codeVerifier) {
            ...
            OAuth2AuthCodePKCE.generatePKCECodes = function () {
              var output = new Uint32Array(
                exports.RECOMMENDED_CODE_VERIFIER_LENGTH
              );
              crypto.getRandomValues(output);
              var codeVerifier = OAuth2AuthCodePKCE.base64urlEncode(
                Array.from(output)
                  .map(function (num) {
